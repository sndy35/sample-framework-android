...
import com.telstra.utils.CommandLineParameters;
import com.telstra.android.testdata.Test;
import com.telstra.android.testdata.TestParameters;
import com.telstra.android.testdata.Testdata;
...
public class BaseTest {
	...
	public void handleTestMethodName(ITestContext ctx) {
		logger.startTest(ctx.getCurrentXmlTest().getName());
		try {
			int attempts = 0;
